                ...
                <div className={"row mt-4"}>
                    <div className={"col-4"}>
                        ...
                        <div>
                            ...
                            {pkTableName && <span className="form-control">{tableNameToFqName(pkTableName)}</span>}
                        </div>
                    ...
                    <div className={"col-4"}>
                        ...
                        <div>
                            ...
                            {pkTableName != null && fkTableName && <span className="form-control">{tableNameToFqName(fkTableName)}</span>}
                        </div>
